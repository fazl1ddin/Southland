...
(function () {
  ...
  function create() {
    ...
    x2.closePath();
    /* абажур почти белый — «горит»: светлота выше порога, за которым
     * движок не перекрашивает источники света */
    g = x2.createLinearGradient(0, 332, 0, 406);
    g.addColorStop(0, '#f0e8d2');
    g.addColorStop(1, '#f7f0dd');
    x2.fillStyle = g;
    x2.fill();
    ...
    /* ── растение в кадке — правее шторы, вне её зоны перекраски ── */
    leaf(x2, 325, 648, 248, 494, 26, '#77806a');
    leaf(x2, 325, 648, 280, 452, 28, '#68715c');
    leaf(x2, 325, 648, 320, 430, 30, '#828b74');
    leaf(x2, 325, 648, 362, 452, 28, '#6d7663');
    leaf(x2, 325, 648, 394, 502, 26, '#7c8570');
    leaf(x2, 325, 648, 272, 556, 22, '#828b74');
    leaf(x2, 325, 648, 380, 560, 22, '#68715c');
    x2.beginPath();
    x2.moveTo(296, 706); x2.lineTo(354, 706); x2.lineTo(348, 646); x2.lineTo(302, 646);
    x2.closePath();
    x2.fillStyle = '#95866d';
    x2.fill();
    x2.fillStyle = '#a08f74';
    x2.fillRect(294, 634, 62, 14);
    x2.fillStyle = 'rgba(255,255,255,.14)';
    x2.fillRect(302, 648, 8, 56);
